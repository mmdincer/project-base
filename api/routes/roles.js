...
router.post("/update",  auth.checkRoles("role_update") , async (req, res) => {
    try {
      ...
      if(userRole) throw new CustomError(Enum.HTTP_CODES.FORBIDDEN, i18n.translate("COMMON.NEED_PERMISSIONS", req.user?.language), i18n.translate("COMMON.NEED_PERMISSIONS", req.user?.language));
